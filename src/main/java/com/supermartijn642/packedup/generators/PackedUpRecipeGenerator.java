...
public class PackedUpRecipeGenerator extends RecipeGenerator {
    ...
    public void generate(){
        ...
        // Copper
        Tag<Item> copperIngots = new ItemTags.Wrapper(new ResourceLocation("forge", "ingots/copper"));
        ...
        // Silver
        Tag<Item> silverIngots = new ItemTags.Wrapper(new ResourceLocation("forge", "ingots/silver"));
