...
public class PackedUpRecipeGenerator extends RecipeGenerator {
    ...
    public void generate(){
        ...
        this.shaped("basic_from_chest", PackedUp.basicbackpack)
            ...
            .pattern("CCC")
            .input('A', Items.STICK)
            .input('B', ConventionalItemTags.STRINGS)
            .input('C', Items.LEATHER)
            .input('D', ConventionalItemTags.CHESTS)
            .unlockedBy(ConventionalItemTags.CHESTS)
        ...
        ResourceCondition silverEnabled = new BackpackRecipeCondition(BackpackType.SILVER).and(new TagPopulatedResourceCondition(Registries.ITEMS, new ResourceLocation("c", "ingots/silver")));
