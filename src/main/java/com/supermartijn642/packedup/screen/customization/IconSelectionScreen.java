...
public class IconSelectionScreen extends ItemBaseWidget {
    ...
    @Override
    public void renderBackground(MatrixStack poseStack, int mouseX, int mouseY, ItemStack stack){
        // Background
    ...
    public void render(MatrixStack poseStack, int mouseX, int mouseY, ItemStack stack){
        ...
        RenderSystem.translatef(67, 7, 0);
        RenderSystem.scalef(42 / 16f, 42 / 16f, 1);
