...
public class BackpackCustomizationScreen extends ItemBaseWidget {
    ...
    public BackpackCustomizationScreen(EnumHand hand){
        super(0, 0, 192, 48,
    ...
    protected void addWidgets(ItemStack stack){
        ...
        this.addWidget(new IconSlotWidget(8, 20, this.hand,
            () -> this.object,
            () -> ClientUtils.getMinecraft().displayGuiScreen(WidgetScreen.of(new IconSelectionScreen(this.hand)))
        ));
    }
    ...
    public void render(int mouseX, int mouseY, ItemStack stack){
        ScreenUtils.drawString(TITLE, 9, 7, 4210752);
